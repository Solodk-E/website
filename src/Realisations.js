...
function Realisations() {
  return (
    ...
    <div className="title"><span className='spanNumber'>3.</span>Réalisations<div className="titleLine"></div></div>
    <div id="reaAff">
        <div id="cadreIll"><img  id="photoRea" src="./imagePortfolio.jpg" alt="Elton Solodki portfolio screenschot"/></div>
            <div id="reaDoc">
                <div id="reaFirst">
                ...
                <a href="http://google.com" target="_blank" rel="noopener noreferrer"><BsFolderSymlink className="icon"/></a>
                 </div>
                </div>
